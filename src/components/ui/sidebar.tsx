...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-12 px-6 py-6 flex flex-row md:hidden  items-center justify-between black-gradient w-full"
        )}
        {...props}
      >
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2  group/sidebar py-2 rounded-md transition-colors",
        active && "bg-white/10 text-white",
        !active && "text-neutral-200 hover:bg-white/5",
        className
      )}
      {...props}
    >
